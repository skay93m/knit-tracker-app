        ...
        rowData.forEach((symbol, c) => {
            ...
            if (symbol === "c2r" || symbol === "c2l" || symbol === "c3r" || symbol === "c3l") {
                ...
                if (is6) {
                    ...
                    // Bound vertical coordinates between y=3 and y=21 to increase padding matching standard symbols
                    cell.innerHTML = isC3L ? `
                      <svg width="100%" height="100%" viewBox="0 0 144 24" preserveAspectRatio="none" style="display: block; opacity: 0.55;">
                        <!-- Underlap line (broken solid line with a center gap) slanting from bottom-left (12px, y=21) to top-right (132px, y=3) -->
                        <line x1="12" y1="21" x2="60" y2="13.8" stroke="#000000" stroke-width="1.2" stroke-linecap="round"/>
                        <line x1="84" y1="10.2" x2="132" y2="3" stroke="#000000" stroke-width="1.2" stroke-linecap="round"/>
                        <!-- Overlap line (continuous solid line) slanting from bottom-right (132px, y=21) to top-left (12px, y=3) -->
                        <line x1="132" y1="21" x2="12" y2="3" stroke="#000000" stroke-width="1.2" stroke-linecap="round"/>
                      </svg>
                    ` : `
                      <svg width="100%" height="100%" viewBox="0 0 144 24" preserveAspectRatio="none" style="display: block; opacity: 0.55;">
                        <!-- Underlap line (broken solid line with a center gap) slanting from bottom-right (132px, y=21) to top-left (12px, y=3) -->
                        <line x1="132" y1="21" x2="84" y2="13.8" stroke="#000000" stroke-width="1.2" stroke-linecap="round"/>
                        <line x1="60" y1="10.2" x2="12" y2="3" stroke="#000000" stroke-width="1.2" stroke-linecap="round"/>
                        <!-- Overlap line (continuous solid line) slanting from bottom-left (12px, y=21) to top-right (132px, y=3) -->
                        <line x1="12" y1="21" x2="132" y2="3" stroke="#000000" stroke-width="1.2" stroke-linecap="round"/>
                      </svg>
                    `;
                } else {
